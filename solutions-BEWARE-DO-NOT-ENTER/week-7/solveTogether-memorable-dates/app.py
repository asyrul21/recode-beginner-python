...
while(True):
    ...
    if(userAction == 1):
        # try:
        eventDate = input("Type the birthdate in the format of DD/MM/YYYY: ")
        event = input("What happened on this date?: ")

        # attempt to convert to date object to test
        # user has input a valid date
        # this will throw error if date in invalid
        ...
        print()
        tableDisplay.display(data)
        showMessage("New memorable date added!")
        # except:
        #     print()
